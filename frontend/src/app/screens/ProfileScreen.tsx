      ...
      <div className="px-4 -mt-16 pb-6">
        <div className="flex flex-col items-center">
          ...
          <p className="text-sm text-muted-foreground">
            @{user?.username?.toLowerCase().replace(/\s/g, "") ?? "gast"}
          </p>
        ...
        <div className="mt-8">
          ...
          {interests.length === 0 ? (
            <p className="text-sm text-muted-foreground">Noch keine Interessen ausgewählt.</p>
          ) : (
                  ...
                  >
                    ...
                    >
                      <div className="w-full h-full bg-gradient-to-t from-black/60 via-transparent to-transparent flex items-end p-3">
                        <p className="text-sm text-white font-medium line-clamp-2">{event.name}</p>
                      </div>
                    </div>
                  </Card>
                );
      ...
      <AlertDialog open={showLogoutDialog} onOpenChange={setShowLogoutDialog}>
        <AlertDialogContent className="max-w-sm mx-4">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>Möchtest du dich wirklich ausloggen?</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
